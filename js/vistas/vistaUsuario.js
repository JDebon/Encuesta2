...
var VistaUsuario = function(modelo, controlador, elementos) {
    ...
    this.modelo.voto.suscribir(function() {
    ...
    reconstruirGrafico: function() {
        ...
        preguntas.forEach(function(clave) {
            ...
            respuestas.forEach(function(elemento) {
                listaParaGrafico.push([elemento.respuesta, elemento.cantidad]);
            });
    ...
    mostrarRespuestas: function(listaPreguntas, respuestas, clave) {
        respuestas.forEach(function(elemento) {
            listaPreguntas.append(
                $('<input>', {
                    type: 'radio',
                    value: elemento.respuesta,
                    name: clave.id
                })
            );
            listaPreguntas.append(
                $('<label>', {
                    for: elemento.respuesta,
                    text: elemento.respuesta
                })
            );
        });
    },
